...
def main():
    ...
    if data_args.max_length > tokenizer.model_max_length:
        logger.warning(
            f"The max_seq_length passed ({data_args.max_length}) is larger than the maximum length for the"
            f"model ({tokenizer.model_max_length}). Using max_seq_length={tokenizer.model_max_length}."
        )
    max_seq_length = min(data_args.max_length, tokenizer.model_max_length)
    ...
    if training_args.do_train:
        ...
        def compute_loss(params, buffers, kwargs):
        ...
        def get_func(batch: dict):
            return vmap(
                grad_and_value(compute_loss, has_aux=True),
        ...
        for epoch in range(int(training_args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_loader):
                ...
                ft_per_sample_grads, batch_loss = get_func(batch)(
